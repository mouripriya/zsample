		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bol",
									"targetURL": "#comzsamplebolzsamplebol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzsamplebolzsamplebol-display": {
								"semanticObject": "comzsamplebolzsamplebol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zsamplebol.zsamplebol",
									"url": sap.ui.require.toUrl("com/zsamplebol/zsamplebol")
								}
							}
						}
					}
